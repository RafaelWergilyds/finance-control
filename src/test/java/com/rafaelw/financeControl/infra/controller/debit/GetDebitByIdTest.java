...
public class GetDebitByIdTest extends DBContainer {
  ...
  @Test
  @DisplayName("Should be able to find a debit by id")
  void getById() {
    ...
    given().header("Authorization", "Bearer " + token)
        .get("/debits/1").then().statusCode(200)
        .body("id", equalTo(1), "name", is("Pizza"));
  }
}
